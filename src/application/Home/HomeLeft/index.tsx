...
import { leggoItemStore, StandardFormItem } from '../../../api/config'
...
export function LeggoLeft() {  
  ...
  const [storeKey, setStoreKey]= useState('total')
  ...
  return (
    <Fragment>
      <div>
        ...
        <Menu defaultSelectedKeys={['total']} mode="inline" onSelect={({key}) => setStoreKey(key)}>
          { menuItems }
        </Menu>
      </div>
      <div className="leggo-configs-left">
      <div style={{"color":"#5DADF7" ,"fontSize":"25px","textAlign":"center","fontWeight":"bold"}}>组件库</div>
        <Form {...layout}>
