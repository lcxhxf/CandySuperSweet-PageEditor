...
import { TOnGetSchemaModel, TSchema } from '../../../type/interface'
import { leggoItemStore, LeggoSchema } from '../../../api/config'
...
export function LeggoMiddle(props: React.PropsWithoutRef<{
  ...
  return (
    <div className="leggo-configs-middle">
     <div style={{"color":"#5DADF7" ,"fontSize":"25px","margin":"0 auto","fontWeight":"bold"}}>编辑区</div>
      <div className="top-area">
        ...
        <div className="top-actions">
          ...
          <Button onClick={clearAllSchemas}>一键清空</Button>
        </div>
      </div>
